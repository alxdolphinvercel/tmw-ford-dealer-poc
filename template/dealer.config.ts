...
/**
 * TEMPLATE reference config (Hendy Ford).
 *
 * Each deployed site carries its own copy of this file — it is the only file
 * that differs between the five POC sites. Everything here maps to the
